      ...
      <div className={`bg-gray-900 rounded-lg p-3 mb-3 ${isSelected ? 'border border-[#00A8FF]' : ''}`}>
        ...
        {showActions && (
          <div className="flex space-x-2 mt-3">
            <button
              onClick={onSelect}
              className="flex-1 bg-[#00A8FF] text-white py-1.5 px-3 rounded text-sm font-medium hover:bg-opacity-90 transition-colors"
            >
              Select Coach
            </button>
            <button
              onClick={() => setShowProfile(true)}
              className="flex-1 bg-gray-950 text-white py-1.5 px-3 rounded text-sm font-medium hover:bg-gray-900 transition-colors"
            >
              View Profile
            </button>
          </div>
